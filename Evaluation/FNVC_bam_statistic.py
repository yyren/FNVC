...
parser.add_argument('--in_model', type=str, default="FNVC_bam_model.bin", 
            help="the output training model name with path, default:FNVC_bam_model.bin")

parser.add_argument('--out_file', type=str, default="FNVC_bam_summary.txt", 
            help="statistic result file, default:FNVC_bam_summary.txt")
...
def readData(file_path1, file_path2):
    ...
    # Return X, y
    return combined.iloc[:, 11:-2].values, combined.iloc[:, 0].values
