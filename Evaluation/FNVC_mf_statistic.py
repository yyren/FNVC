...
parser.add_argument('--in_model', type=str, default="FNVC_mf_model.bin", 
            help="the output training model name with path, default:FNVC_mf_model.bin")

parser.add_argument('--out_file', type=str, default="FNVC_mf_summary.txt", 
            help="statistic result file, default:FNVC_mf_summary.txt")
